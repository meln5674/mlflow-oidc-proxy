...
cp /src/integration-test/MLflow-example-notebook.ipynb mlflow-example/
...
# jupyter nbconvert --execute --stdout /src/integration-test/MLflow-example-notebook.ipynb --to notebook --output-dir /output/ 
papermill --log-output /src/integration-test/MLflow-example-notebook.ipynb /output/MLflow-example-notebook.ipynb
